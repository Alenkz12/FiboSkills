...
4. **Module imports**:
   - Standard library (e.g., os, sys, json) is marked as "third-party"
   - Third-party packages (e.g., numpy, pandas, django) are marked as "third-party"
   - Relative imports and in-project modules are marked as "custom"
